...
const createExam = async (req, res) => {
  try {
    ...
    const exam = await Exam.create({ usuarioId, materiaId, titulo, fecha, descripcion: descripcion || null });
...
const updateExam = async (req, res) => {
  try {
    ...
    await exam.update({
      titulo: titulo !== undefined ? titulo : exam.titulo,
      fecha: fecha !== undefined ? fecha : exam.fecha,
      descripcion: descripcion !== undefined ? descripcion : exam.descripcion,
    });
